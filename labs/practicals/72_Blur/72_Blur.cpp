...
bool render() {
  ...
  glUniform1f(tex_eff.get_uniform_location("inverse_width"), (1.0f / frame.get_width()));
  // Set inverse height Uniform
  glUniform1f(tex_eff.get_uniform_location("inverse_height"), (1.0f / frame.get_height()));
